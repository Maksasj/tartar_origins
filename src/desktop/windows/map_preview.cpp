...
namespace to {
    /*
    void MapPreviewWindow::draw_grid(std::vector<std::shared_ptr<Node>>& gates, ImDrawList* drawList) {
    ...
    void MapPreviewWindow::draw_nodes(std::vector<std::shared_ptr<Node>>& gates, ImDrawList* drawList) {
    ...
    */
    ...
    MapPreviewWindow::MapPreviewWindow() : CommonWindow("Map preview") {
